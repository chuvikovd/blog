...
<div
  class={`flex p-5 fixed top-0 right-0 z-10 after:empty-content after:absolute after:bg-cyan after:w-6 after:h-6 cursor-pointer transition-mode ${dayValue ? 'active' : ''}`}
  on:click={toggle}>
  <svg viewBox="0 0 512 512" class="w-6 mr-4">
    <path
      class="fill-yellow"
      d="M256 160c-52.9 0-96 43.1-96 96s43.1 96 96 96 96-43.1
